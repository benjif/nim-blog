...
/* Command for C compiler:
   gcc -c  -w  -I/home/benji/.nim/lib -o /home/benji/dev/nim/website/src/nimcache/stdlib_parseutils.c.o /home/benji/dev/nim/website/src/nimcache/stdlib_parseutils.c */
...
N_LIB_PRIVATE N_NIMCALL(NI, parseSaturatedNatural_heAOnV8CAiOgwhPKbfpRgA)(NimStringDesc* s, NI* b, NI start) {
	...
	result = (NI)0;
	nimln_(301, "parseutils.nim");
	i = start;
	nimln_(302, "parseutils.nim");
	{
		NIM_BOOL T3_;
	...
	nimln_(303, "parseutils.nim");
	{
		...
		LA10_: ;
		if (!T9_) goto LA11_;
		nimln_(304, "parseutils.nim");
		(*b) = ((NI) 0);
		{
			nimln_(305, "parseutils.nim");
			while (1) {
				NIM_BOOL T15_;
				NI c;
				...
				nimln_(307, "parseutils.nim");
				{
					...
					if (!((*b) <= (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_15))) goto LA19_;
					nimln_(308, "parseutils.nim");
